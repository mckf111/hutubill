...
public class SpendPanel extends WorkingPanel {
    ...
    JLabel lMonthSpend = new JLabel("Monthly Cost");
    JLabel lTodaySpend = new JLabel("Daily Cost");
    JLabel lAvgSpendPerDay = new JLabel("Average Cost");
    JLabel lMonthLeft = new JLabel("Monthly Left");
    JLabel lDayAvgAvailable = new JLabel("Daily Available");
    JLabel lMonthLeftDay = new JLabel("Days Left");
 
    JLabel vMonthSpend = new JLabel("EUR 2300");
    JLabel vTodaySpend = new JLabel("EUR 25");
    JLabel vAvgSpendPerDay = new JLabel("EUR 120");
    JLabel vMonthAvailable = new JLabel("EUR 2084");
    JLabel vDayAvgAvailable = new JLabel("EUR 389");
